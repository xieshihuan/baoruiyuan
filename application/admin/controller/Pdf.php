...
<span class="tit_one">时刻篇</span><br />
...
$style = array(
       ...
       //二维码1
        $pdf->write2DBarcode('1111', 'QRCODE,a', 170, 246, 45, 45, $style, 'N');
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
<div class="border"></div><br />
<span class="tit_two">五个意识</span><br />
<div class="border"></div><br />
...
<div class="border"></div><br />
<span class="tit_two">CU人才观</span><br />
<table>
    <tr>
        <td width="80%"></td>
    </tr>
...
$style = array(
       ...
       // QRCODE,Q : QR-CODE Better error correction
       //二维码1
        $pdf->write2DBarcode('1111', 'QRCODE,a', 170, 246, 40, 40, $style, 'N');
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
<div class="border"></div>
<div class="border"></div><br />
<span class="tit_two">CU宣誓词</span><br />
<div class="border"></div>
<div class="border"></div><br />
<span class="tit_two">大自然科学原理</span><br />
<div class="border"></div><br />
EOF;
